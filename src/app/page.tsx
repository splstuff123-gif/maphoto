        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-slate-600 mt-1">Let's user input a photo, grabs the metadata and makes a beautiful portrait of the photo with a pin drop on a map of the photo location underneath
...
- [must] [could] Admin / Settings: Profile, preferences, and basic usage analytics</p>
            </div>
            <button
